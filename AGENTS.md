...
1. **`zenigame-fx-*`**（移植・新設済み）: zenigame-fx 環境で動く正式 skill 群（autopilot, codex-vscode, codex-review, alpha-design, todo-add, todo-close, implement, update-docs, improve-cycle, analyze-run, run-report, run-alpha-factory, plan-and-design 他）
