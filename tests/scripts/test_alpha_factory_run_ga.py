...
def test_smoke_run_holdout_ok(
    ...
    # T046: selection_score_schema v3_1_stage_b_priority (8 要素)
    assert summary["best"]["selection_score_schema"] == "v3_1_stage_b_priority"
    assert len(summary["best"]["selection_score"]) == 8
